...
public class APiGenericConsumerForNativeJava {
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		ExtensionLoader.getExtensionLoader(Serialization.class)
				.getExtension(org.apache.dubbo.rpc.Constants.GENERIC_SERIALIZATION_NATIVE_JAVA).serialize(null, out).writeObject("world");
		...
		System.out.println(ExtensionLoader.getExtensionLoader(Serialization.class)
				.getExtension(org.apache.dubbo.rpc.Constants.GENERIC_SERIALIZATION_NATIVE_JAVA).deserialize(null, in).readObject());
